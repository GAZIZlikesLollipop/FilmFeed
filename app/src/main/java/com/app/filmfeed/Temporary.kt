...
fun getMovs(): List<MovieItem> {
    ...
    val films = listOf(
        MovieItem(
            id = 0,
            name = "Fight Club",
            poster = "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.themoviedb.org%2Ft%2Fp%2Foriginal%2FiqR0M1ln7Kobjp9liUj2Q7mtQZG.jpg&f=1&nofb=1&ipt=de9c89ba87992157c40bc1ad2a956e3e020ede961bf7497b73e6fda29c1781fa",
            movieUrl = "https://archive.org/download/fight-club_202404/Fight%20Club.mp4",
        ...
        MovieItem(
            id = 1,
            name = "Interstellar",
            poster = "https://i.ebayimg.com/00/s/MTYwMFgxMDY2/z/zu4AAOSw2spbJQ0J/\$_57.JPG?set_id=8800005007.jpg",
            ...
            reviews = 1066169,
            description = """
            When drought, dust storms, and plant extinction leave
            humanity with a food crisis, a team of explorers and scientists 
            travel through a wormhole (which supposedly connects
            regions of space-time across vast distances) on a journey to
            surpass previous limitations of human space travel and find 
            a planet with suitable conditions for humanity.
        """,
            country = "USA",
            createdYear = 2014,
        ...
        MovieItem(
            ...
            movieUrl = "~/Downloads/Titanic.mp4",
            categories = listOf(
                MovieCategories.Drama,
                MovieCategories.Thriller,
                MovieCategories.History,
                MovieCategories.MeloDrama
            ),
            rating = 8.4,
            reviews = 908214,
            description = """
            A story of love, tragedy, and human resilience set against the historical disaster of the RMS 
            Titanic, a luxury ocean liner that sank in 1912. The film follows the passionate romance 
            between Jack (Leonardo DiCaprio), a free-spirited artist, and Rose (Kate Winslet), a wealthy 
            socialite, as they navigate the tensions of class, love, and survival. As the ship drifts 
